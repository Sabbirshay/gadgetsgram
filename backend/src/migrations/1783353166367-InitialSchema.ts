...
export class InitialSchema1783353166367 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        if (isPostgres) {
            ...
            await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL PRIMARY KEY, "email" varchar NOT NULL, "password" varchar NOT NULL, "name" varchar NOT NULL, "role" varchar NOT NULL DEFAULT 'admin', "is_active" boolean NOT NULL DEFAULT true, "hashed_refresh_token" varchar, "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"))`);
            await queryRunner.query(`CREATE TABLE "products" ("id" SERIAL PRIMARY KEY, "title" varchar NOT NULL, "slug" varchar NOT NULL, "description" text, "price" decimal(10,2) NOT NULL, "sale_price" decimal(10,2), "nameEn" varchar, "nameBn" varchar, "originalPrice" decimal(10,2), "specs" text, "category" varchar, "inStock" boolean NOT NULL DEFAULT true, "stock" integer NOT NULL DEFAULT 0, "images" text, "status" varchar NOT NULL DEFAULT 'active', "brand" varchar, "averageRating" decimal(3,2) NOT NULL DEFAULT 0, "reviewCount" integer NOT NULL DEFAULT 0, "isFeatured" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, CONSTRAINT "UQ_464f927ae360106b783ed0b4106" UNIQUE ("slug"))`);
            await queryRunner.query(`CREATE TABLE "customers" ("id" SERIAL PRIMARY KEY, "name" varchar NOT NULL, "phone" varchar NOT NULL, "email" varchar, "address" text, "uid" varchar, "orders_count" integer NOT NULL DEFAULT 0, "lifetime_value" decimal(12,2) NOT NULL DEFAULT 0, "last_order_date" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, CONSTRAINT "UQ_88acd889fbe17d0e16cc4bc9174" UNIQUE ("phone"), CONSTRAINT "UQ_aee431c16bdcb3dcf5898adc9a8" UNIQUE ("uid"))`);
            await queryRunner.query(`CREATE TABLE "orders" ("id" SERIAL PRIMARY KEY, "orderId" varchar, "customer_name" varchar NOT NULL, "customer_id" integer REFERENCES "customers" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, "phone" varchar NOT NULL, "alternative_phone" varchar, "address" varchar NOT NULL, "district" varchar NOT NULL, "product_id" integer REFERENCES "products" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, "quantity" integer NOT NULL DEFAULT 1, "price" decimal(10,2) NOT NULL, "delivery_charge" decimal(10,2) NOT NULL DEFAULT 0, "subtotal" decimal(10,2) NOT NULL, "status" varchar NOT NULL DEFAULT 'pending', "courier_tracking_id" varchar, "notes" text, "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, CONSTRAINT "UQ_41ba27842ac1a2c24817ca59eaa" UNIQUE ("orderId"))`);
            await queryRunner.query(`CREATE TABLE "order_status_history" ("id" SERIAL PRIMARY KEY, "order_id" integer NOT NULL REFERENCES "orders" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, "from_status" varchar, "to_status" varchar NOT NULL, "changed_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP)`);
            await queryRunner.query(`CREATE TABLE "notifications" ("id" SERIAL PRIMARY KEY, "order_id" integer, "channel" varchar NOT NULL, "type" varchar NOT NULL, "status" varchar NOT NULL DEFAULT 'pending', "payload" text, "sent_at" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP)`);
            await queryRunner.query(`CREATE TABLE "courier_shipments" ("id" SERIAL PRIMARY KEY, "order_id" integer NOT NULL, "courier_name" varchar NOT NULL, "tracking_id" varchar, "status" varchar NOT NULL DEFAULT 'pending', "booked_at" TIMESTAMP, "delivered_at" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP)`);
            await queryRunner.query(`CREATE TABLE "audit_logs" ("id" SERIAL PRIMARY KEY, "user_id" integer, "action" varchar NOT NULL, "entity" varchar NOT NULL, "entity_id" integer, "changes" text, "ip_address" varchar, "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP)`);
            await queryRunner.query(`CREATE TABLE "settings" ("id" SERIAL PRIMARY KEY, "key" varchar NOT NULL, "value" text, "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, CONSTRAINT "UQ_c8639b7626fa94ba8265628f214" UNIQUE ("key"))`);
            await queryRunner.query(`CREATE TABLE "inventory_transactions" ("id" SERIAL PRIMARY KEY, "product_id" integer NOT NULL REFERENCES "products" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, "type" varchar NOT NULL CHECK( "type" IN ('IN','OUT','RESERVED','RETURNED','ADJUSTMENT') ), "quantity" integer NOT NULL, "reference_id" varchar, "notes" varchar, "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP)`);
            await queryRunner.query(`CREATE TABLE "customer_wishlist" ("customer_id" integer NOT NULL REFERENCES "customers" ("id") ON DELETE CASCADE ON UPDATE CASCADE, "product_id" integer NOT NULL REFERENCES "products" ("id") ON DELETE CASCADE ON UPDATE CASCADE, PRIMARY KEY ("customer_id", "product_id"))`);
